...
# with command line options: step3 -s HARVESTING:dqmHarvesting --harvesting AtRunEnd --conditions auto:run3_data --era Run3 --geometry DB:Extended --scenario pp --hltProcess reHLT --filein file:step2_RAW2DIGI_L1Reco_RECO_DQM.root --filetype DQM -n -1 --data
